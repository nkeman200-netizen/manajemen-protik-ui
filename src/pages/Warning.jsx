    ...
    return (
      <div className="flex h-full items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-sm text-slate-400">Memuat data peringatan...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="flex h-full items-center justify-center">
        <div className="flex flex-col items-center gap-4 rounded-2xl border border-red-500/20 bg-red-500/10 px-8 py-6">
          ...
          <div className="text-center">
            ...
            <p className="mt-1 text-sm text-red-400/70">Terjadi kesalahan saat mengambil data peringatan.</p>
          </div>
        </div>
      </div>
    );
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-white">Surat Peringatan</h1>
            <p className="text-xs text-slate-400">
              {meta?.total ?? 0} peringatan terdaftar
            </p>
          </div>
        </div>
        {isAdmin && (
                ...
                warnings.map((item) => (
                  ...
                  >
                    ...
                    <td className="whitespace-nowrap px-6 py-4">
                      <span className="rounded-lg bg-amber-500/15 px-2.5 py-1 text-xs font-semibold text-amber-400">
                        {item.admin?.name ?? '-'}
                      </span>
                    </td>
                  </tr>
